  ...
  MobileArea.prototype = {
    ...
    bindEvent: function() {
      ...
      function areaCtrlInit() {
        _self.gearArea
          ...
          .setAttribute('val', _self.value[0]);
        _self.gearArea
          .querySelector('.area_city')
          .setAttribute('val', _self.value[1]);
        _self.gearArea
          .querySelector('.area_county')
          .setAttribute('val', _self.value[2]);
    ...
    setGearTooth: function(data) {
      ...
      if (l > 0) {
        ...
        gearChild[_self.index].style['-webkit-transform'] =
          'translate3d(0,' + -gearVal * 2 + 'em,0)';
    ...
    finish: function(e) {
      ...
      var provinceCode = area_province.childNodes[provinceVal].getAttribute(
        'ref'
      );
